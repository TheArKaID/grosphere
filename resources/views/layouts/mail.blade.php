    ...
    <div class="message">
        <div class="upper-section">
            ...
            <div class="button-container" style="text-align: center;">
                <a class="button" href="https://grosphere.sg"
        ...
        <div class="footer-section"
            ...
            <div class="button-group" style="margin-top: 1rem">
                <a href="https://grosphere.sg"
                    style="text-decoration: none; color: #ffffff; font-weight: 600; margin: 0 0.5rem;">Home</a>
                <a href="https://grosphere.sg"
                    style="text-decoration: none; color: #ffffff; font-weight: 600; margin: 0 0.5rem;">FAQ</a>
                <a href="https://grosphere.sg"
                    style="text-decoration: none; color: #ffffff; font-weight: 600; margin: 0 0.5rem;">Contact
                    Us</a>
            </div>
